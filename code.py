...
class Province:
    ...
    def __init__(self, name, is_sc = False, land_neighbour_list = [], coast_neighbours = {}):
        '''
        ...
        '''
        self.name = name
        self.land_neighbours = land_neighbour_list
        self.coasts = coast_neighbours
        self.units = dict.fromkeys(['land'] + list(self.coasts.keys()),False) 
        self.sc = is_sc
        
        # self.units is a dictonary with as keys the different locations of units in a province (i.e. land and coast)
        # and as value True or False depending on whether there is a unit there.
    ...
    def get_land_neighbours(self):
        return self.land_neighbours
